...
from user_exceptions import ValueErrorException, NotMatrixException, WrongTypeException
...
class Matrix:
    ...
    def __init__(self, a_matrix: list[list[int, float]]) -> None:
        if not self.check(a_matrix):
            ...
            raise ValueErrorException(a_matrix)
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, (int, float)):
            ...
            raise WrongTypeException(other)
